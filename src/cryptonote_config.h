...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x184f16;
...
const uint64_t MONEY_SUPPLY                                  = (uint64_t)(300000000000000);
...
const char     CRYPTONOTE_NAME[]                             = "SolanumCityCoin";
